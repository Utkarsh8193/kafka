...
public class TransactionDAO implements Serializable{
	...
	//static final TableName LOOKUP_TABLE            = "look_up";
	static final TableName LOOKUP_TABLE = TableName.valueOf("look_up");
	static final String CARD_TRANSACTIONS_TABLE = "card_transactions";
	static final String COLUMN_FAMILY_NAME      = "cfl";
	...
	static boolean TABLE_CREATED = false;
	...
	public static Double getUCL(TransactionPOJO transaction) throws IOException {
		...
		try {
			...
			if (hbaseAdmin != null){	
				...
				boolean bool = hbaseAdmin.tableExists(LOOKUP_TABLE);
